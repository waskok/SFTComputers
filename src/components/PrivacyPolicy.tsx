...
/**
 * "Podstrona" polityki prywatności — technicznie to wciąż ten sam index.html
 * (wymóg hostingu po samym FTP, bez routera po stronie serwera), ale otwiera się
 * pod własnym adresem (#polityka-prywatnosci), więc można ją wysłać jako link,
 * cofnąć się do niej przyciskiem "wstecz" przeglądarki itd. Header i pasek
 * ogłoszeń zostają zamontowane bez zmian - działają dokładnie tak samo jak na
 * stronie głównej.
 */
export default function PrivacyPolicy() {
  return (
    <main className="min-h-screen bg-white pt-40 pb-24 sm:pt-44 lg:pt-40">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mt-3 text-sm text-slate-500">Ostatnia aktualizacja: {new Date().toLocaleDateString("pl-PL")}</p>

        <div className="mt-10 flex flex-col gap-10 text-slate-600">
          <section>
            ...
            <p className="mt-3 leading-relaxed">
              ...
              {company.registry.company}, {company.address.full} ({company.registry.nip}, {company.registry.krs},{" "}
              {company.registry.regon}). Kontakt w sprawach dotyczących ochrony danych osobowych:{" "}
              <a href={`mailto:${company.email}`} className="font-semibold text-blue-700 hover:underline">
                {company.email}
              </a>{" "}
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900">2. Jakie dane zbieramy i w jakim celu</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900">3. Podstawa prawna przetwarzania</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900">4. Okres przechowywania danych</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900">5. Odbiorcy danych</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900">6. Twoje prawa</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900">7. Dobrowolność podania danych</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900">9. Zmiany polityki prywatności</h2>
            <p className="mt-3 leading-relaxed">
