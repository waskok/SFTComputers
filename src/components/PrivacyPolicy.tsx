    ...
    <main className="min-h-screen bg-white pt-40 pb-24 text-slate-600 sm:pt-44 lg:pt-40 dark:bg-[#0b0f19] dark:text-slate-300">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 flex flex-col gap-10 text-slate-600 dark:text-slate-300">
          ...
          <section className="rounded-3xl border border-slate-100 bg-slate-50/50 p-6 sm:p-8 dark:border-slate-800/80 dark:bg-slate-900/60">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">2. Jakie dane zbieramy i w jakim celu</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="rounded-3xl border border-slate-100 bg-slate-50/50 p-6 sm:p-8 dark:border-slate-800/80 dark:bg-slate-900/60">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">3. Podstawa prawna przetwarzania</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="rounded-3xl border border-slate-100 bg-slate-50/50 p-6 sm:p-8 dark:border-slate-800/80 dark:bg-slate-900/60">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">4. Okres przechowywania danych</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="rounded-3xl border border-slate-100 bg-slate-50/50 p-6 sm:p-8 dark:border-slate-800/80 dark:bg-slate-900/60">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">5. Odbiorcy danych</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="rounded-3xl border border-slate-100 bg-slate-50/50 p-6 sm:p-8 dark:border-slate-800/80 dark:bg-slate-900/60">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">6. Twoje prawa</h2>
          ...
          <section className="rounded-3xl border border-slate-100 bg-slate-50/50 p-6 sm:p-8 dark:border-slate-800/80 dark:bg-slate-900/60">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">7. Dobrowolność podania danych</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="rounded-3xl border border-slate-100 bg-slate-50/50 p-6 sm:p-8 dark:border-slate-800/80 dark:bg-slate-900/60">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">8. Bezpieczeństwo danych</h2>
            <p className="mt-3 leading-relaxed">
          ...
          <section className="rounded-3xl border border-slate-100 bg-slate-50/50 p-6 sm:p-8 dark:border-slate-800/80 dark:bg-slate-900/60">
            <h2 className="text-lg font-bold text-slate-900 dark:text-white">9. Zmiany polityki prywatności</h2>
            <p className="mt-3 leading-relaxed">
