      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3">
            <p className="text-sm font-bold text-white">Dane rejestrowe</p>
            ...
            <div className="mt-4 flex flex-col gap-2 text-sm text-slate-400">
              <a href={company.phoneHref} className="flex items-center gap-2 hover:text-blue-400">
                <Phone className="h-4 w-4" /> {company.phone}
              </a>
              <a href={`mailto:${company.email}`} className="flex items-center gap-2 hover:text-blue-400">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-slate-800/80 pt-8 sm:flex-row">
          ...
          <div className="flex items-center gap-6">
            <a href={privacyPolicyHash} className="text-xs text-slate-500 hover:text-blue-400">
